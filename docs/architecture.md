...
- `campaignActions.js` — the dirty flag (Save indicator, leave-page guard), header campaign controls (Save/Undo/Redo/New/Load example/Export/Import), cross-tab reload-on-save; provides `markDirty`/`setDirty`.

...
- [ ] **Phase I** — accessibility pass (see below; promoted from campaign-lifecycle gap #10)
...
- [ ] Accessibility pass: keyboard map nav, ARIA/text alternative for canvas content, modal focus management — promoted to Phase I in the UI-overhaul checklist above
...
- [ ] Include support for the "discoverable" parameter already on each tile
